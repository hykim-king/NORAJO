...
/*────────────────────────────────────content────────────────────────────────────*/
	...
	.section_detail{margin:0; padding:0; display: block; color: white;}
	
	.txt_title{font-weight: 600; font-size: 40px; line-height: 20px; color:#000; margin:0; color: white;}
	
	.box_basic{position: flex; padding: 70px 0 60px 0; border-bottom: 4px solid white; 
	           display:flex; line-height:2.0; color: white;}
	
	.poster_item{width:250px; height: 300px; border: 1px solid white; text-align: center; color: white;}
	
	.info_detail{width: 600px; height: 300px; border: 1px solid white;text-align: center; color: white;}
	
	.movie_summary{float:left; width: 800px; padding-bottom: 7px; margin:  0; 
	               padding: 0; line-height: 3.0; font-weight: bold; color: white;}
	
	.movie_summary_item{font-size:1.25rem; font-weight: 30; color: white;}
	
  .info_detail_items{text-align:left; padding : 10px; color: white;}
